...
class MkPFSApp:
    ...
    def _build_pack_folder_tab(self, parent: ctk.CTkFrame) -> None:
        ...
        self.pack_case_var: tk.BooleanVar = tk.BooleanVar(value=False)
        self.pack_verify_var: tk.BooleanVar = tk.BooleanVar(value=True)
        self.pack_require_game_var: tk.BooleanVar = tk.BooleanVar(value=True)
    ...
    def _build_pack_archive_tab(self, parent: ctk.CTkFrame) -> None:
        ...
        self.pack_archive_case_var: tk.BooleanVar = tk.BooleanVar(value=False)
        self.pack_archive_verify_var: tk.BooleanVar = tk.BooleanVar(value=True)
        self.pack_archive_require_game_var: tk.BooleanVar = tk.BooleanVar(value=True)
    ...
    def _apply_pack_preset(self, version: str, compress: bool) -> None:
        ...
        self.pack_case_var.set(False)
        self.pack_verify_var.set(True)
        self.pack_require_game_var.set(True)
